...
We will use the [airqual dataset](https://ww2.arb.ca.gov/capp/cst/rdi/air-quality-and-emissions-data) to interpolate [ozone](https://oehha.ca.gov/calenviroscreen/indicator/air-quality-ozone) levels for California (averages for 1980-2009). Download the  file *kriging.zip* from Canvas in the Week 8 Lab and Assignment folder. It contains all the files that will be used in this guide. Bring in the file *airqual.shp*, which contains ozone levels (among many other variables, which we will not use) for control points scattered throughout California. We'll keep spatial objects in **sf** form since many of the kriging functions work with them.
...
![](kriging_files/figure-html/unnamed-chunk-4-1.png)<!-- -->
...
![](kriging_files/figure-html/unnamed-chunk-12-1.png)<!-- -->
...
![](kriging_files/figure-html/unnamed-chunk-13-1.png)<!-- -->
...
![](kriging_files/figure-html/unnamed-chunk-16-1.png)<!-- -->
...
![](kriging_files/figure-html/unnamed-chunk-17-1.png)<!-- -->
...
![](kriging_files/figure-html/unnamed-chunk-19-1.png)<!-- -->
...
![](kriging_files/figure-html/unnamed-chunk-24-1.png)<!-- -->
...
![](kriging_files/figure-html/unnamed-chunk-25-1.png)<!-- -->
...
![](kriging_files/figure-html/unnamed-chunk-30-1.png)<!-- -->
...
```
## [1] 5.967864 6.973699 6.667093 8.863368 6.195943
```
...
![](kriging_files/figure-html/unnamed-chunk-35-1.png)<!-- -->
...
![](kriging_files/figure-html/unnamed-chunk-39-1.png)<!-- -->
...
You must be tired of running models on California. For your assignment, let's instead predict precipitation for the great state of [Texas](https://www.texas.gov/)! Bring in the files *precip* and *texas*.  
...
![](kriging_files/figure-html/unnamed-chunk-43-1.png)<!-- -->
