...
In the next lab you will start exploring spatial data in R. Although *MN* is not spatialized, it does have spatial information, longitude and latitude, which allows us to crudely plot it. 
