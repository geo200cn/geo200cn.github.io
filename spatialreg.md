...
tm_shape(zctanyc, unit = "mi") +
  tm_polygons(fill = "covidrate", 
              fill.scale = tm_scale(style = "quantile",values = "blues"), 
              fill.legend = tm_legend(title = "",
              position = tm_pos_out("right", "center")))+
  tm_scalebar(breaks = c(0, 2.5, 5), text.size = 1, 
              position = tm_pos_in("right", "bottom")) +
  tm_title("COVID-19 cases per 1,000 residents by NYC zip codes") +
...
tm_shape(zctanyc, unit = "mi") +
  ...
  tm_scalebar(breaks = c(0, 2.5, 5), text.size = 1, 
              position = tm_pos_in("right", "bottom")) +
  tm_title("Residuals from linear regression") +
  tm_layout(scale = 1, frame = FALSE)
```
...
``` r
moran.plot(zctanyc$covidrate, listw=nycw, xlab="COVID-19 Case Rate", 
           ylab="Lagged COVID-19 Case Rate", 
...
## 
## statistic = 0.023944, observed rank = 696, p-value = 0.304
...
## pblk dy/dx       0.04856330681  0.08892198731  0.13748529412
## phisp dy/dx      0.07620920998  0.13954310050  0.21575231049
## medincome dy/dx -0.00001700018 -0.00003112824 -0.00004812842
## totp dy/dx      -0.00002845456 -0.00005210180 -0.00008055636
## p65old dy/dx     0.22563896431  0.41315689640  0.63879586071
```
...
##                        Direct      Indirect         Total
## pblk dy/dx      0.01553605070 0.03131220709 0.04493914652
## phisp dy/dx     0.02322053241 0.04837722361 0.06838387393
## medincome dy/dx 0.00001283348 0.00002530718 0.00003773079
## totp dy/dx      0.00001346371 0.00002839968 0.00004106481
## p65old dy/dx    0.07171556647 0.15952486439 0.22217440262
## 
## Simulated z-values:
##                    Direct  Indirect     Total
## pblk dy/dx       3.134820  2.885407  3.094211
## phisp dy/dx      3.344203  2.979387  3.243289
## medincome dy/dx -1.303683 -1.232684 -1.270224
## totp dy/dx      -2.072975 -1.847580 -1.957408
## p65old dy/dx     3.219419  2.708519  2.983956
## 
## Simulated p-values:
##                 Direct     Indirect  Total    
## pblk dy/dx      0.00171960 0.0039091 0.0019734
## phisp dy/dx     0.00082519 0.0028883 0.0011816
## medincome dy/dx 0.19234154 0.2176936 0.2040049
## totp dy/dx      0.03817460 0.0646631 0.0502995
## p65old dy/dx    0.00128450 0.0067584 0.0028455
```
...
## number of simulations + 1: 1000 
## 
## statistic = -0.04723, observed rank = 222, p-value = 0.778
## alternative hypothesis: greater
```
...
## Coefficients: (asymptotic standard errors) 
##                 Estimate   Std. Error z value    Pr(>|z|)
## (Intercept) 12.226926357  2.689463361  4.5462 0.000005461
## pblk         0.061604531  0.022419248  2.7478    0.005999
## phisp        0.122124863  0.029625877  4.1222 0.000037521
## medincome   -0.000019168  0.000014531 -1.3191    0.187120
## totp        -0.000020288  0.000011160 -1.8180    0.069068
## p65old       0.188907337  0.070122942  2.6939    0.007061
## 
...
## test weights: listw
## 
## RSerr = 139.96, df = 1, p-value < 0.00000000000000022
## 
## 
## 	Rao's score (a.k.a Lagrange multiplier) diagnostics for spatial
## 	dependence
...
## test weights: listw
## 
## RSlag = 137.42, df = 1, p-value < 0.00000000000000022
## 
## 
## 	Rao's score (a.k.a Lagrange multiplier) diagnostics for spatial
## 	dependence
...
## test weights: listw
## 
## adjRSerr = 11.124, df = 1, p-value = 0.0008521
## 
## 
## 	Rao's score (a.k.a Lagrange multiplier) diagnostics for spatial
## 	dependence
...
## test weights: listw
## 
## adjRSlag = 8.5867, df = 1, p-value = 0.003386
```
