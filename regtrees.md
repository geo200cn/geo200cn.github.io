...
The misclassification error rate is the training error rate, which is around 10%. 
...
<p class="comment">**Question 3**: Describe the conditions under which you are likely to find our species. </p>
...
![](regtrees_files/figure-html/unnamed-chunk-24-1.png)<!-- -->
...
<p class="comment">**Question 4**: Plot the decision tree diagram. How many terminal nodes are there? Describe the conditions under which you are likely to find our species. </p>

<p class="comment">**Question 5**: Explain how pruning may affect the bias and variance of your predictions. </p>
...
<p class="comment">**Question 6**: What are the differences between the error rate shown here and the error rate shown earlier in summary(cart1)? </p>
...
```
## mtry = 6  OOB error = 0.05597023 
## Searching left ...
```

```
## mtry = 3 	OOB error = 0.05553913 
## 0.007702314 0.05 
## Searching right ...
```

```
## mtry = 12 	OOB error = 0.05616594 
## -0.003496771 0.05
```

![](regtrees_files/figure-html/unnamed-chunk-28-1.png)<!-- -->
...
## 
##           Mean of squared residuals: 0.05339405
##                     % Var explained: 66.2
```

<br>

<p class="comment">**Question 7**: What did tuneRF help us find? What does the value of *mt* represent? </p>
...
![](regtrees_files/figure-html/unnamed-chunk-31-1.png)<!-- -->
...
![](regtrees_files/figure-html/unnamed-chunk-34-1.png)<!-- -->
...
## 1     0.474         0.474       0.391            0.194           0.474
## 
## @tr_stats
##     treshold kappa  CCR  TPR  TNR  FPR  FNR  PPP  NPP  MCR  OR
## 1          0     0 0.19    1    0    1    0 0.19  NaN 0.81 NaN
## 2          0  0.21 0.52    1 0.41 0.59    0 0.29    1 0.48 Inf
## 3          0  0.21 0.52    1 0.41 0.59    0 0.29    1 0.48 Inf
## 4        ...   ...  ...  ...  ...  ...  ...  ...  ...  ... ...
## 642        1   0.1 0.82 0.07    1    0 0.93    1 0.82 0.18 Inf
## 643        1   0.1 0.82 0.07    1    0 0.93    1 0.82 0.18 Inf
## 644        1     0 0.81    0    1    0    1  NaN 0.81 0.19 NaN
```
...
```
##   max_kappa max_spec_sens no_omission equal_prevalence equal_sens_spec
## 1 0.4735048     0.4735048   0.3905143        0.1937712       0.4735048
```
...
![](regtrees_files/figure-html/unnamed-chunk-37-1.png)<!-- -->
...
![](regtrees_files/figure-html/unnamed-chunk-38-1.png)<!-- -->
...
![](regtrees_files/figure-html/unnamed-chunk-42-1.png)<!-- -->
...
![](regtrees_files/figure-html/unnamed-chunk-43-1.png)<!-- -->
...
<p class="comment">**Question 8**: Why would it be that the model does not extrapolate well to eastern North America? </p>
...
![](regtrees_files/figure-html/unnamed-chunk-47-1.png)<!-- -->


<br>

<p class="comment">**Question 9**: Make a map to show where conditions are improving for western bigfoot, and where they are not. Is the species headed toward extinction? </p>
