...
## 
## Call:
## lm(formula = evict ~ punemp + rent + pburden + county, data = sac_metro)
## 
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -1.9465 -0.7858 -0.1945  0.4473  6.1335 
## 
## Coefficients:
##                    Estimate Std. Error t value     Pr(>|t|)    
## (Intercept)       1.8629267  0.3975317   4.686 0.0000038450 ***
## punemp            0.0450461  0.0158958   2.834      0.00484 ** 
## rent             -0.0003750  0.0001995  -1.880      0.06083 .  
## pburden           0.0168047  0.0055942   3.004      0.00284 ** 
## countyPlacer     -1.5965741  0.2627132  -6.077 0.0000000029 ***
## countySacramento -0.3940800  0.1982022  -1.988      0.04748 *  
## countyYolo       -1.1914162  0.2676958  -4.451 0.0000111741 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 1.115 on 392 degrees of freedom
## Multiple R-squared:  0.2239,	Adjusted R-squared:  0.212 
## F-statistic: 18.85 on 6 and 392 DF,  p-value: < 0.00000000000000022
```
